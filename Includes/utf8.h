...
inline utf8_int8_t *utf8cat(utf8_int8_t *utf8_restrict dst,
...
inline utf8_int8_t *utf8cpy(utf8_int8_t *utf8_restrict dst,
                     const utf8_int8_t *utf8_restrict src) {
  utf8_int8_t *d = dst;
...
inline utf8_int8_t *utf8dup(const utf8_int8_t *src) {
  return utf8dup_ex(src, utf8_null, utf8_null);
}

inline utf8_int8_t *utf8dup_ex(const utf8_int8_t *src,
...
inline utf8_int8_t *utf8ncat(utf8_int8_t *utf8_restrict dst,
...
inline utf8_int8_t *utf8ncpy(utf8_int8_t *utf8_restrict dst,
                      const utf8_int8_t *utf8_restrict src, size_t n) {
  utf8_int8_t *d = dst;
...
inline utf8_int8_t *utf8ndup(const utf8_int8_t *src, size_t n) {
  return utf8ndup_ex(src, n, utf8_null, utf8_null);
}

inline utf8_int8_t *utf8ndup_ex(const utf8_int8_t *src, size_t n,
                         utf8_int8_t *(*alloc_func_ptr)(utf8_int8_t *, size_t),
                         utf8_int8_t *user_data) {
...
inline int utf8makevalid(utf8_int8_t *str, const utf8_int32_t replacement) {
...
inline void utf8lwr(utf8_int8_t *utf8_restrict str) {
  utf8_int32_t cp = 0;
...
inline void utf8upr(utf8_int8_t *utf8_restrict str) {
  utf8_int32_t cp = 0;
  utf8_int8_t *pn = utf8codepoint(str, &cp);
